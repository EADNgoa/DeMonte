...
AS
	...
	insert Into RptRegister(BillID,Name,Address,PassportDet,NoOfGuest,NoOfRooms,DateArrivalTime,DateDepartureTime,ChargesPerDay,RoomNo,TotalDays, TotalCharges, PaidInForeignIndian,EncashCertDetails,Remarks)
